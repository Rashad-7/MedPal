...
export class MedicationService {
  ...
  async addMedication(
    ...
    const {
      medicationName, dosage, repeat, repeatEveryHours,
      reminderTime, sideEffects, warningLevel,
      activeIngredient, category, contraindications,
      interactions, instructions, startDate,
    } = body;
